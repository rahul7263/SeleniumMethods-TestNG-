...
public class ScreenShot {
	...
	@Test
	public void screenshot_demo() throws IOException, InterruptedException{
	    ...
	    driver.manage().window().maximize();
		 ...
		 FileUtils.copyFileToDirectory(src,new File("C:\\Users\\Rahul\\git\\SeleniumMethods-TestNG-\\screenshots"));
		 Thread.sleep(1000);
